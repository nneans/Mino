...
function App() {
  ...
  const handlePlaceSearch = (keyword, callback) => {
    ...
    else setTimeout(() => handlePlaceSearch(keyword, callback), 300)
  }
        ...
        <div className="onboarding-screen">
          <div className="onboarding-content">
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              <button className="btn btn-secondary" style={{ backgroundColor: '#8b5cf6', color: 'white' }} onClick={() => setIsDemoMode(true)}>🎮 데모 모드</button>
            </div>
          </div>
        </div>
