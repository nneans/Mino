...
const screenshots = [
<<<<<<< HEAD
  { src: '/images/dashboard.png', title: '대시보드', desc: '대시보드에서 수입, 지출, 저축 목표를 한눈에 관리하세요.' },
  { src: '/images/sync.png', title: '지출 동기화', desc: 'Gmail과 연동하여 카드 결제 내역을 자동으로 가져옵니다.' },
  { src: '/images/insight.png', title: '인공지능 소비 분석', desc: 'AI가 사용자님의 소비 패턴을 분석하고 맞춤형 리포트를 제공합니다.' },
  { src: '/images/report.png', title: '차트로 확인하는 월간/연간 재정 리포트', desc: '정확한 수치와 차트로 재정 흐름을 직관적으로 파악하세요.' },
  { src: '/images/chat.png', title: '개인 금융 비서 Mino', desc: 'LLM 기반 AI가 사용자님의 지출과 목표를 반영하여 답변합니다.' },
=======
...
>>>>>>> 8f14124 (fix: restore unique screenshots with correct captions and no overlay)
];
